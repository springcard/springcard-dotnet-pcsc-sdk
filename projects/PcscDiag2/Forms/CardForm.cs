...
namespace PcscDiag2
{
    ...
    public partial class CardForm : Form
    {
        ...
        public CardForm(Settings settings, string ReaderName, Image ReaderImage, OnCloseCallback OnClose)
            : base()
        {
        ...
        void UpdateButtons()
        {
            ...
            btnCCtrlPrev.Enabled = hist_ctrl_idx < settings.ControlHistoryCount - 1;
     ...
     */
        void BtnControlClick(object sender, EventArgs e)
        {
            ...
            settings.ControlHistoryAdd(cctrl.AsString());
            hist_ctrl_idx = -1;
        ...
        public void HistoryTransmit(int way)
        {
            ...
            string s = settings.TransmitHistoryGet(i);
        ...
        public void HistoryControl(int way)
        {
            ...
            string s = settings.ControlHistoryGet(i);
        ...
        {
            ConnectForm f = new ConnectForm(settings);
        ...
        {
            ReconnectForm f = new ReconnectForm(settings);
            if (f.ShowDialog() == DialogResult.OK)
            {
        ...
        {
            DisconnectForm f = new DisconnectForm(settings);
            if (f.ShowDialog() == DialogResult.OK)
            {
